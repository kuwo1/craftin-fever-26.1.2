...
public class FeverFoods {
    ...
    public static final FoodProperties CORN = new FoodProperties.Builder().nutrition(3).saturationModifier(0.25f).build();
    ...
    public static final Consumable CIDER_CONSUMABLE = Consumables.defaultDrink()
            .consumeSeconds(1f).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 200), 0.15f)).build();
    public static final Consumable CORN_CONSUMABLE = Consumables.defaultFood()
            .consumeSeconds(1f).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 200), 0.15f)).build();
}
